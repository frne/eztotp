...
<div class="context-block">
    ...
    <form name="loginform" method="post" action={'/eztotp/login/'|ezurl}>
                ...
                <div class="box-content">
                    ...
                    <div class="context-attributes">
                        ...
                        <div class="block">
                            ...
                            <input class="halfbox" type="text" size="10" name="Login" id="id1"
                                   value="{$User:login|wash}" tabindex="1"
                        ...
                        <div class="block">
                            ...
                            <input class="halfbox" type="text" size="10" name="TotpKey" id="id3"
                                   value="" tabindex="1"
                                   title="{'The Key from your Google Authenticator'|i18n( 'design/admin/user/login' )}"/>
                        </div>

                    {if and( ezini_hasvariable( 'Session', 'RememberMeTimeout' ), ezini( 'Session', 'RememberMeTimeout' ) )}
                        <div class="block">
                            <input type="checkbox" tabindex="1" name="Cookie" id="id3"/><label for="id3"
                                ...
                                <div class="box-br">
                                    <div class="block">
                                        <input class="button" type="submit" name="LoginButton"
                                               value="{'Log in'|i18n( 'design/admin/user/login', 'Login button' )}"
                                               tabindex="1"
                                        ...
                                        <input class="button" type="submit" name="RegisterButton"
                                               value="{'Register'|i18n( 'design/admin/user/login', 'Register button' )}"
                                               tabindex="1"
                                               title="{'Click here to create a new account.'|i18n( 'design/admin/user/login' )}"/>
                                    </div>
